...
La migración `db:migrate:access` agrega la separación entre usuarios de plataforma y cliente, el cupo de usuarios por licencia y el control de sesión única. Debe ejecutarse antes de reiniciar el backend.
