              ...
              (fila) => (
                ...
                >
                  ...
                  <td>
                    <input
                      type="number"
                      {...quantityInput([...alimentosOptions, ...materialesDisponibles, ...aditivosDisponibles, ...medicamentosDisponibles].find((item) => item.value === (fila.item || fila.alimento || fila.material || fila.aditivo || fila.medicamento))?.unitCode)}
                      value={
                        fila.cantidad
                      }
                      onChange={(
